...
console.log(nature_lover(100,10,910));
// console.log(nature_lover(5, 2, 19));
// console.log(nature_lover(8, 7, 23));
// console.log(">>>>>result: ",nature_lover(14, 7, 28));
// console.log(nature_lover(3, 1, 10));
